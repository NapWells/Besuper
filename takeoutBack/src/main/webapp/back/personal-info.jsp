...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<%=basePath%>back/personal-info.jsp" class="active"><i class="fa fa-fw fa-table"></i>个人信息</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <form role="form" method="post" id="managerInfoForm">

                            <div class="form-group">
                                <label>昵称</label>
                                <input class="form-control" name="nickname" value="${sessionScope.manager.nickname}">
                            </div>

                            <div class="form-group">
                                <label>邮箱</label>
                                <input class="form-control" name="email" placeholder="请输入您的邮箱" value="${sessionScope.manager.email}">
                            </div>

                            <div class="form-group">
                                <label>电话</label>
                                <input class="form-control" name="phone" placeholder="请输入您的电话" value="${sessionScope.manager.phone}">
                            </div>
                            <button id="submitButton" type="submit" class="btn btn-default">保存修改</button>
    ...
    <script src="<%=basePath%>resources/js/personal-info.js"></script>
</body>
